...
function recipesStore(state = initialState, action){
...
const store = createStore(recipesStore);
...
const addRecipeBtn = document.querySelectorAll('.addRecipe')[0];
addRecipeBtn.addEventListener('click', () => {
    const resipeName = document.querySelectorAll('.trackInput')[0].value;
    console.log('recipeName', resipeName);
    store.dispatch({ type: 'ADD_RECIPE', payload: resipeName})
